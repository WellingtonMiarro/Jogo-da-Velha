...
function atualizarMostrador(){
    ...
    if(playTime == jogador1){
        ...
        var jogador = document.querySelectorAll("div#mostrador img")[0];
        jogador.setAttribute("src", "img/O.jpg");
    }
}
        ...
        espacos[i].addEventListener("click", function(){
            ...
            if(this.getElementsByTagName("img").length == 0){
                if(playTime == jogador1){
                    ...
                    this.innerHTML = "<img src='img/X.png' borde='0' height='50px'>"
                    this.setAttribute("jogada", jogador1);
                    playTime = jogador2;

                }else{

                    this.innerHTML = "<img src='img/O.jpg'borde='0' height='50px'>"
...
async function verificarVencedor(){
    ...
    } else if(((c3 == c2 && c3 == c1) || (c3 == a3 && c3 == b3 && b2 !=""))&& c3 !=""){
        vencedor = c3;
